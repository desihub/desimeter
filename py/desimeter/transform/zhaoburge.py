...
# LUT = [0, 1, 2,   5, 6,    9,  15,  20,  27, 28, 29, 30]   # 12 polynomials out of 33
# parm 0, 1, 2,   3, 4,    6,   7,   8,   9, 10, 11, 12      # parm numbers
#  ZB: S2,S3,S4, S7,S8,   S11, S17, S22, T4, T7, T8, T11     # Zhao-Burge labels
